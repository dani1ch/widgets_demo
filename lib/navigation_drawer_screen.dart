            ...
            child: ListView(
              ...
              children: [
                ...
                title: const Text("Каталог"),
                  onTap: (){
                    _messengerKey.currentState!.showSnackBar(
                      const SnackBar(content: Text("Переходим в каталог"))
                    );
                  },
            ),
                ListTile(
                  ...
                  onTap: (){
                    _messengerKey.currentState!.showSnackBar(
                        const SnackBar(content: Text("Переходим в корзину"))
                    );
                  },
                ),
                const Divider(),
                ...
                ListTile(
                  ...
                  onTap: (){
                    _messengerKey.currentState!.showSnackBar(
                        const SnackBar(content: Text("Переходим в настройки"))
                    );
                  },
                ),
              ],
